...
<head>
  ...
  <style>
    ...
    /* Keyframe for the smaller circle pulsing */
    ...
    /* Note the missing dot is added here */
    .mic-icon::before,
    .mic-icon::after {
      content: "";
      display: block;
    ...
    /* Corrected “berder” to “border” and set color to #fff */
    .mic-icon::after {
      border: 2px solid #fff;
      width: 8px;
      height: 18px;
    ...
    /* Keyframe for the rotating shadow */
